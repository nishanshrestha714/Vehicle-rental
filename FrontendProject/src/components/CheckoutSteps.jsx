...
//                 ):<Nav.Link  className='text-black'>signin</Nav.Link>
//             }
//         </Nav.Item>
//         <Nav.Item>
//             {
//                 step2?(
//                     <Nav.Link  as ={Link} to="/shipping"> Next steps</Nav.Link>
//                 ):<Nav.Link className='text-black'>Next steps</Nav.Link>
//             }
//         </Nav.Item>
//         <Nav.Item>
//             {
//                 step3?(
//                     <Nav.Link  as ={Link} to="/nagarikta"> nagarikta </Nav.Link>
//                 ):<Nav.Link className='text-black'>nagarikta</Nav.Link>
//             }
//         </Nav.Item>
//         <Nav.Item>
//             {
...
//                 ):<Nav.Link className='text-black'>license </Nav.Link>
//             }
//         </Nav.Item>
//         <Nav.Item>
//             {
...
//                 ):<Nav.Link className='text-black'>booking</Nav.Link>
//             }
//         </Nav.Item>
//         <Nav.Item>
//             {
//                 step7?(
//                     <Nav.Link  as ={Link} to="/rental"> rental</Nav.Link>
//                 ):<Nav.Link className='text-black'>rental</Nav.Link>
//             }
//         </Nav.Item>
//         </Nav>
//     )
