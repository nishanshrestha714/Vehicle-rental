...
// //         <Card.Img className="border border-1 border-light  rounded hover hover-shadow shodow-lg w-75 img-fluid "  style={{  }}  src={ vehicle.image}  variant="top" />
// //       </Link>
// //         <Card.Body>
// //           <Card.Title as="div" className="vehicle-title">
// //          <Link to={`/vehicle/${vehicle._id}`} className="text-decoration-none  text-capitalize">
// //            <strong> {vehicle.name}</strong>
// //          </Link>
// //           </Card.Title>
// //           <Card.Text as="div" className="mx-1   mb-3">
// //             <Rating  className="text-warning text-capitalize "  value={vehicle.rating} text ={vehicle.numReview}/>
// //           </Card.Text>
