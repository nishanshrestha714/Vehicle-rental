...
// function BookingDetalis() {
//   const { id } = useParams();
//   const cart = useSelector((state) => state.cart);
//   const { Nagariktapage, License, CartItems, PaymentMethod } = cart;
//   const { data: booking, isLoading, error } = useGetBookingByIdQuery(id);
//   console.log("this is booking details", booking);
//   // const Name = {booking?.bookingId?.user?.firstName + " " + booking?.bookingId?.user?.lastName}
//   const name = `${booking?.bookingId?.user?.firstName || ""} ${booking?.bookingId?.user?.lastName || ""}`;

//   return (
//     <>
//       <h1>this is booking details pages </h1>
...
//                 <a href={`mailto:${booking?.bookingId?.user.email}`}>
//                   {booking?.bookingId?.user.email}
//                 </a>
//               </p>
//               <p>
//                 <strong>address</strong> {Nagariktapage.permentAddress}
//               </p>
...
//                 {booking?.bookingId?.vehicle?.name}{" "}
//               </p>{" "}
//               <p>
//                 <strong>pickupDate:</strong>
//                 {booking?.bookingId?.bookingPeriod.start}{" "}
//               </p>
//               <p>
//                 <strong>returnDate:</strong>
//                                {booking?.bookingId?.bookingPeriod.end}{" "}

//               </p>
//               <p>
//                 <strong>totalDays:</strong>
//                 {booking?.bookingId?.totalDays}{" "}
//               </p>
//               <p>
//                 <strong>totalPrice:</strong>
//                 {booking?.bookingId?.totalPrice}{" "}
//               </p>
//               <p>
//                 <strong>Price per day:</strong>
//                 {booking?.bookingId?.vehicle?.pricePerDay}{" "}
//               </p>{" "}
//             </ListGroup.Item>
//             <ListGroup>
//               <ListGroup.Item>
...
//                   {booking?.bookingId?.dropLocation}{" "}
//                 </p>{" "}
//                 <p>
//                   <strong>pickupLocation:</strong>
//                   {booking?.bookingId?.pickupLocation}{" "}
//                 </p>
//               </ListGroup.Item>
...
//                     {booking?.bookingId?.payment?.method == 'COD'?<Badge>cash on delevery</Badge>:<Badge bg="success">E-Sewa</Badge> }
//                     {booking?.bookingId?.payment?.isPaid ? (<SuccessMessage>paid on </SuccessMessage>) :(<ErrorMessage className="text-white  bg-danger">payment vako xaina </ErrorMessage>)}
