...
//    toast.success( res.message || "Nagarikta saved successfully");
//       setShowStatus(true);
//       setTimeout(() => {
//         navigate("/license");
//       }, 3000);
...
//                       {/* Date of Birth */}
//                       {/*  controlId was "DateOfBirth" — DUPLICATE with permentAddress below
...
//                       {/* Permanent Address */}
//                       {/* controlId was "DateOfBirth" — DUPLICATE, now fixed to "permentAddressField" */}
//                       <Col md={6} className="mb-3">
